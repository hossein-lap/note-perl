...
xref:perl/syntax/syntax-02-numbers.adoc[numbers] and
xref:perl/syntax/syntax-03-strings.adoc[strings],
...
xref:perl/syntax/syntax-06-array.adoc[array], not
xref:perl/syntax/syntax-07-hash.adoc[hashes]. In addition, the interpolation is
