...
either xref:perl/syntax/syntax-02-numbers.adoc[numbers],
xref:perl/syntax/syntax-03-strings.adoc[strings], or more complex such as a
xref:perl/syntax/syntax-05-list.adoc[list]. Data is held as value.
...
xref:perl/syntax/syntax-01-variables.adoc[Perl variables].
...
xref:perl/syntax/syntax-02-numbers.adoc[number], complex expression with
xref:perl/syntax/syntax-04-operators.adoc[operators], or a
xref:perl/syntax/syntax-18-subroutine.adoc[function (aka subroutine)], call.
...
xref:perl/syntax/syntax-19-module.adoc[modules], and other objects. Check it
